...
Back-of-manual index. **Covers only the transcribed chapters so far** (Introduction,
Cooling System, Starting System) — it grows as more chapters are cleaned. Each entry links
to its spot in the chapter markdown and cites the source PDF page.
...
- Cooling fan, electric — on-vehicle inspection — [04-cooling-system.md#p186](04-cooling-system.md#p186) ([PDF p.186])
...
- Engine serial number location (4A-FE / 4A-GE) — [01-introduction.md#p5](01-introduction.md#p5) ([PDF p.5])
...
- Hold-in test (starter magnetic switch) — [07-starting-system.md#p211](07-starting-system.md#p211) ([PDF p.211])
...
- Pull-in test (starter magnetic switch) — [07-starting-system.md#p211](07-starting-system.md#p211) ([PDF p.211])
